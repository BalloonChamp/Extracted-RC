...
/**
 * @fileoverview FTC robot blocks related to test.
 * @author lizlooney@google.com (Liz Looney)
 */

// The following are generated dynamically in HardwareUtil.fetchJavaScriptForHardware():
// testIdentifierForJavaScript
...
Blockly.Blocks['test_addNumericData'] = {
  init: function() {
    this.appendDummyInput()
        .appendField('call')
        .appendField(createNonEditableField('Test'))
        .appendField('.')
...
Blockly.JavaScript['test_addNumericData'] = function(block) {
  ...
  return testIdentifierForJavaScript + '.addNumericData(' + key + ', ' + number + ');\n';
};

Blockly.FtcJava['test_addNumericData'] = function(block) {
  ...
  return 'test.addData(' + key + ', ' + number + ');\n';
};

Blockly.Blocks['test_addNumericData_Number'] = {
  init: function() {
    this.appendDummyInput()
        .appendField('call')
        .appendField(createNonEditableField('test'))
...
Blockly.JavaScript['test_addNumericData_Number'] =
    Blockly.JavaScript['test_addNumericData'];

Blockly.FtcJava['test_addNumericData_Number'] =
    Blockly.FtcJava['test_addNumericData'];

Blockly.Blocks['test_addTextData'] = {
  init: function() {
    this.appendDummyInput()
        .appendField('call')
        .appendField(createNonEditableField('test'))
...
Blockly.JavaScript['test_addTextData'] = function(block) {
  var key = Blockly.JavaScript.valueToCode(
      block, 'KEY', Blockly.JavaScript.ORDER_COMMA);
  var text = Blockly.JavaScript.valueToCode(
      block, 'TEXT', Blockly.JavaScript.ORDER_COMMA);
  return 'testAddTextData(' + key + ', ' + text + ');\n';
};

Blockly.FtcJava['test_addTextData'] = function(block) {
  var key = Blockly.FtcJava.valueToCode(
      block, 'KEY', Blockly.FtcJava.ORDER_COMMA);
  var text = Blockly.FtcJava.valueToCode(
      block, 'TEXT', Blockly.FtcJava.ORDER_COMMA);
  return 'test.addData(' + key + ', ' + text + ');\n';
};

Blockly.Blocks['test_addTextData_All'] = {
  init: function() {
    this.appendDummyInput()
        .appendField('call')
        .appendField(createNonEditableField('test'))
...
Blockly.JavaScript['test_addTextData_All'] =
    Blockly.JavaScript['test_addTextData'];

Blockly.FtcJava['test_addTextData_All'] =
    Blockly.FtcJava['test_addTextData'];

Blockly.Blocks['test_update'] = {
  init: function() {
    this.appendDummyInput()
        .appendField('call')
        .appendField(createNonEditableField('test'))
...
Blockly.JavaScript['test_update'] = function(block) {
  return testIdentifierForJavaScript + '.update();\n';
};

Blockly.FtcJava['test_update'] = function(block) {
  return 'test.update();\n';
};

Blockly.Blocks['test_speak'] = {
  init: function() {
    this.appendDummyInput()
        .appendField('call')
        .appendField(createNonEditableField('test'))
...
Blockly.JavaScript['test_speak'] = function(block) {
  var text = Blockly.JavaScript.valueToCode(
      block, 'TEXT', Blockly.JavaScript.ORDER_COMMA);
  var languageCode = "''";
  var countryCode = "''";
  return 'testSpeak(' + text + ', ' + languageCode + ', ' + countryCode + ');\n';
};

Blockly.FtcJava['test_speak'] = function(block) {
  var text = Blockly.FtcJava.valueToCode(
      block, 'TEXT', Blockly.FtcJava.ORDER_COMMA);
  return 'test.speak(' + text + ', null, null);\n';
};

Blockly.Blocks['test_speak_withLanguage'] = {
  init: function() {
    this.appendDummyInput()
        .appendField('call')
        .appendField(createNonEditableField('test'))
...
Blockly.JavaScript['test_speak_withLanguage'] = function(block) {
  var text = Blockly.JavaScript.valueToCode(
      block, 'TEXT', Blockly.JavaScript.ORDER_COMMA);
...
Blockly.FtcJava['test_speak_withLanguage'] = function(block) {
  var text = Blockly.FtcJava.valueToCode(
      block, 'TEXT', Blockly.FtcJava.ORDER_COMMA);
  ...
  return 'test.speak(' + text + ', ' + languageCode + ', ' + countryCode + ');\n';
};

Blockly.Blocks['test_setDisplayFormat'] = {
  init: function() {
    this.appendDummyInput()
        .appendField('call')
        .appendField(createNonEditableField('test'))
    ...
    this.appendValueInput('DISPLAY_FORMAT').setCheck('test.DisplayFormat')
        .appendField('displayFormat')
        .setAlign(Blockly.ALIGN_RIGHT);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setColour(functionColor);
    this.setTooltip('Sets the test display format on the Driver Station.');
  }
};

Blockly.JavaScript['test_setDisplayFormat'] = function(block) {
  var displayFormat = Blockly.JavaScript.valueToCode(
      block, 'DISPLAY_FORMAT', Blockly.JavaScript.ORDER_NONE);
  return testIdentifierForJavaScript + '.setDisplayFormat(' + displayFormat + ');\n';
};

Blockly.FtcJava['test_setDisplayFormat'] = function(block) {
  var displayFormat = Blockly.FtcJava.valueToCode(
      block, 'DISPLAY_FORMAT', Blockly.FtcJava.ORDER_NONE);
  return 'test.setDisplayFormat(' + displayFormat + ');\n';
};

// Enums

Blockly.Blocks['test_typedEnum_displayFormat'] = {
  init: function() {
    ...
    this.setOutput(true, 'test.DisplayFormat');
    this.appendDummyInput()
...
Blockly.JavaScript['test_typedEnum_displayFormat'] = function(block) {
  var code = '"' + block.getFieldValue('DISPLAY_FORMAT') + '"';
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};

Blockly.FtcJava['test_typedEnum_displayFormat'] = function(block) {
  var code = 'test.DisplayFormat.' + block.getFieldValue('DISPLAY_FORMAT');
  Blockly.FtcJava.generateImport_('test');
